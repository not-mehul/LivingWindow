...
import { SPECIES, PSTYLE, ANIM, gaitPose, gaitAt, CRITTER_VOICES, speciesIcon } from "./species.js?v=18";
import { mulberry32, parseColor, css, mix, themeVar, REDUCED } from "./util.js?v=18";
